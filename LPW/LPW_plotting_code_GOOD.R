...
ggsave(
  filename = paste0("Model Results/", "LPW", "_model_comparison_boxplots_", timestamp, ".png"),
  plot = composite_plot,
...
ggsave(
  filename = paste0("Model Results/", "LPW", "_wavenumber_importance_combined_", timestamp, ".png"), # Desired file name
...
ggsave(
  filename = paste0("Model Results/", "LPW", "_ECDF_hatch_", timestamp, ".png"), # Desired file name
...
ggsave(
  filename = paste0("Model Results/", "LPW", "_agepredictions_", timestamp, ".png"), # Desired file name
...
gtsave(table_to_export_full, paste0("Model Results/", "LPW", "_resultstable_all_colored)", timestamp, ".html"))
...
gtsave(filtered_table_final, paste0("Model Results/", "LPW", "_resultstable_filtered_colored_", timestamp, ".html"))
