...
rm(global_gam, global_lm, top5_gam, top5_lm, pc_df, pca_temp, global_gam_filter, global_lm_filter, pc_filter_df, pca_filter_temp)
rm(dredge_gam, dredge_gam_filter, dredge_lm, dredge_lm_filter)
```
