...
# --- C. Global Parameters ---
N_SPLITS <- 50 # Number of different train/test data splits (e.g., 500)
...
BEST_PARAMS_XGB <- readRDS("Model Results/LPW_best_xgb_params_tuned_2025-10-31.RDS")
BEST_PARAMS_RF <- readRDS("Model Results/LPW_best_RF_params_tuned_2025-10-31.RDS")
...
saveRDS(gam_predictors_table, paste0("Model Results/", "LPW_", "GAM_PCsused_", timestamp, ".RDS"))
saveRDS(lm_predictors_table,  paste0("Model Results/", "LPW_", "LM_PCsused_", timestamp, ".RDS"))
...
timestamp <- format(Sys.Date(), "%Y-%m-%d")
saveRDS(final_results_summary, paste0("Model Results/", "LPW", "_SUMMARY_all_models_", timestamp, ".RDS"))
saveRDS(final_predictions_df, paste0("Model Results/", "LPW", "_PREDICTIONS_all_models_", timestamp, ".RDS"))
saveRDS(final_importance_summary, paste0("Model Results/", "LPW", "_IMPORTANCE_all_models_", timestamp, ".RDS"))
